...
TITLES = {
    ...
    "phases/phase-1-scraper": ("Phase 1 · Scraper", "Raw data capture — static + social scrapers."),
    "phases/phase-2-ai-taxonomy": ("Phase 2 · AI Taxonomy", "Standardization + predictive conditions."),
    "phases/phase-3-curation": ("Phase 3 · Curation", "Human taste / master index / zero-garbage UGC."),
    "phases/phase-4-trip-planner": ("Phase 4 · Trip Planner", "The actionable dashboard (live today)."),
...
GROUPS = [
    ...
    ("Architecture", ["architecture/overview", "architecture/current-state", "architecture/data-flow",
                       "architecture/retrieval-agent"]),
    ...
    ("Data & Taxonomy", ["data/taxonomy", "data/tags", "data/route-schema", "data/grade-conversion",
                          "data/schemas", "data/database", "data/condition-algorithm",
