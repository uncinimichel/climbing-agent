...
GROUPS = [
    ...
    ("Data & Taxonomy", ["data/taxonomy", "data/tags", "data/route-schema", "data/grade-conversion",
                          "data/schemas", "data/database", "data/source-of-truth", "data-dependencies",
                          "corpus-inspector", "data/condition-algorithm", "data/references", "data/external-models"]),
    ("Operations", ["operations/deployment", "operations/external-apis", "operations/runbook",
                     "operations/testing-plan"]),
