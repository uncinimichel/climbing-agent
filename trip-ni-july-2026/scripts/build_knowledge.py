...
TITLES = {
    ...
    "data/mp-field-mapping": ("MP Field Mapping", "How multi-pitch.com's fields map onto the route schema and taxonomy."),
...
GROUPS = [
    ...
    ("Data & Taxonomy", ["data/taxonomy", "data/tags", "data/route-schema", "data/grade-conversion",
                          ...
                          "corpus-inspector", "data/condition-algorithm", "data/weather-models", "data/route-weather-geometry", "data/mp-field-mapping",
