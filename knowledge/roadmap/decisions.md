...
**Status:** ⚠️ Partial — schema live (applied additively; apply.sh untouched), Topo Studio working (verified: Sammy Higgins topo renders from imported data), booklet renderer + coverage gate + Studio merge deliberately not started.
