...
#
# aspect is a CRAG attribute (Michel, 2026-09-05): a region holds many crags
# facing many ways, so region-level entries (dolomites, lake district, mallorca,
# anti atlas …) deliberately carry NONE — each climb card draws its own crag's
# facing from the corpus record. Single-crag entries keep one: vratsa S, freyr
# W, lundy W (corpus route facings); campanile basso / spitzkoppe "all" (a
# tower/dome has a wall every way).
GAZETTEER = {
