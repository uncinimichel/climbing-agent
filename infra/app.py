...
Five stacks, deployed independently as the milestones land:
  ...
  Studio    -> ClimbingAgentStudio (CloudFront + Lambda Curation Studio over the S3 record, #40 — live)

(The corpus lives as the JSON record on S3 — decisions #39/#41; there is no DB stack.)
...
# Region fixed by the plan (§2). Account id from CDK_DEFAULT_ACCOUNT (deploys/
# local synth), answered from the committed cdk.context.json in credential-less
# CI synth.
